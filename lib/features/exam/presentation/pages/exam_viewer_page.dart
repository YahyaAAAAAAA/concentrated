...
class ExamViewerPage extends StatefulWidget {
  const ExamViewerPage({super.key});

  @override
  State<ExamViewerPage> createState() => _ExamViewerPageState();
}

class _ExamViewerPageState extends State<ExamViewerPage> {
  @override
  void initState() {
    super.initState();

    context.read<ExamViewerCubit>().loadSubjects();
  }
